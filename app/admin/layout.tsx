...
import { Icon123, IconDashboard, IconLogout, IconRipple, IconSailboat, IconUser, IconUsers, IconUsersGroup } from "@tabler/icons-react";
  ...
  return (
    <>
      ...
      >
        ...
        <h1 className='text-xl font-bold text-center'>Movimento Mercantil RJ</h1>
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            ...
            >
              <div
              className="flex flex-row items-center justify-center text-blue-400"
              >
                <IconUser />
