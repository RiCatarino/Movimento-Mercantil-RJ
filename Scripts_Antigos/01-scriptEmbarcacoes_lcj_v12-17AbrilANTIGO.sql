...
CREATE  TABLE bd_embarcacoes.viagem ( 
	...
	entrada_sahida       varchar(7) NOT NULL,
	dias_viagem			 smallint,
	dias_porto_destino   smallint    ,
	...
	CONSTRAINT ck01_viagem CHECK (entrada_sahida = ANY ('{Entrada, Sahida}'::text[]))	
 );
...
CREATE  TABLE bd_embarcacoes.escala ( 
	...
	CONSTRAINT idx01_escala UNIQUE ( id_viagem, id_porto ) ,
...
CREATE  TABLE bd_embarcacoes.relac_mercadoria_escala ( 
	...
	CONSTRAINT idx01_relac_mercadoria_escala UNIQUE ( id_escala, id_mercadoria ) ,
	CONSTRAINT fk03_relac_mercadoria_escala FOREIGN KEY ( consignatario ) REFERENCES bd_embarcacoes.pessoa( id )   ,
	...
	CONSTRAINT fk04_relac_mercadoria_escala FOREIGN KEY ( id_unidade_medida ) REFERENCES bd_embarcacoes.unidade_de_medida( id )   
 );
...
CREATE  TABLE bd_embarcacoes.relac_mercadoria_viagem ( 
	...
	CONSTRAINT fk03_relac_mercadoria_viagem FOREIGN KEY ( consignatario ) REFERENCES bd_embarcacoes.pessoa( id )   ,
	...
	CONSTRAINT fk04_relac_mercadoria_viagem FOREIGN KEY ( id_unidade_medida ) REFERENCES bd_embarcacoes.unidade_de_medida( id )   
 );
...
COMMENT ON COLUMN bd_embarcacoes.viagem.entrada_sahida IS 'entrada ou saída do porto do Rio de Janeiro';

COMMENT ON COLUMN bd_embarcacoes.viagem.dias_porto_destino IS 'número de dias em que a embarcação ficou no destino';
...
COMMENT ON COLUMN bd_embarcacoes.viagem.tripulacao IS 'quantidade de tripulantes na viagem';

COMMENT ON COLUMN bd_embarcacoes.viagem.total_passageiros IS 'Indica o número de passageiros no início da viagem, quando a informação estiver disponível';
...
COMMENT ON CONSTRAINT idx01_escala ON bd_embarcacoes.escala IS 'chave candidata: id_viagem, id_porto';
...
COMMENT ON CONSTRAINT idx01_relac_mercadoria_escala ON bd_embarcacoes.relac_mercadoria_escala IS 'chave candidata: id_escala, id_mercadoria';
...
COMMENT ON COLUMN bd_embarcacoes.relac_mercadoria_escala.consignatario IS 'pessoa ou empresa que financia a viagem (ou parte dela)';
...
COMMENT ON CONSTRAINT fk04_relac_mercadoria_escala ON bd_embarcacoes.relac_mercadoria_escala IS 'relacionamento entre a mercadoria no início da viagem e a respectiva unidade de medida';
...
COMMENT ON COLUMN bd_embarcacoes.relac_mercadoria_viagem.consignatario IS 'pessoa ou empresa que financia a viagem (ou parte dela)';
...
COMMENT ON CONSTRAINT fk04_relac_mercadoria_viagem ON bd_embarcacoes.relac_mercadoria_viagem IS 'relacionamento entre a mercadoria que entra nesta escala e a respectiva unidade de medida';
