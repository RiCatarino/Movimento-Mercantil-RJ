...
0.1.60 - Front-office.
0.1.61 - Front-office finished. Dashboard Fixed. Removed website in development in main page.
0.1.62 - Docs updated.
0.1.63 - Fumadocs default sidebar open, and removed id from viagens table in front office.
0.1.64 - Added observações do escala.
0.1.65 - Limite seleção de datas, corrigir mobile frontoffice, atualizar dependências. Alterar criar para guardar em editar embarcação.
